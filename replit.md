...
- `artifacts/api-server/src/routes/leads.ts` — API авторизации, поиска, клиентов и панели владельца.
- `lib/api-spec/openapi.yaml` — контракт API.

## Architecture decisions

- Общий сервер отвечает за атомарное закрепление компании, чтобы один клиент не выдавался двум менеджерам.
