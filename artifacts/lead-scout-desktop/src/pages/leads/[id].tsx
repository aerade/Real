      ...
      <div className="mx-auto flex min-h-full w-full max-w-6xl flex-col gap-5 overflow-y-auto pb-10 pr-1">
        ...
        <header className="flex flex-col justify-between gap-5 border-b border-border/70 pb-5 lg:flex-row lg:items-start">
          <div className="min-w-0">
            <div className="mb-2 flex flex-wrap items-center gap-2"><span className="rounded-full border border-primary/30 bg-primary/10 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-primary">Карточка компании</span><span data-testid="status-lead" className="rounded-full border border-border/70 bg-card px-2 py-1 text-[10px] text-muted-foreground">{status.label}</span></div>
          ...
          <div className="w-full max-w-md rounded-2xl border border-border/70 bg-card p-4 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1"><div className="flex items-center justify-between gap-3"><p className="text-xs font-semibold">Приоритет компании</p><CircleHelp className="h-4 w-4 shrink-0 text-primary" /></div><p className="mt-1 text-[11px] leading-4 text-muted-foreground">Оценка объединяет сигналы рынка, контактов и действующего сайта.</p></div>
            </div>
